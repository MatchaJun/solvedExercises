...
class Vetor {
  ...
  float Angulo(Vetor tVetor){
    return degrees(acos(this.ProdutoEscalar(tVetor)/(this.Magnitude()*tVetor.Magnitude())));
  }
}

////////////////////////////////////////////////////////////// funções isoladas

boolean VetoresOrtogonais(Vetor tVetor1, Vetor tVetor2){
    if (ProdutoEscalar(tVetor1, tVetor2)==0) return true; else return false;
}

float ProdutoEscalar(Vetor tVetor1, Vetor tVetor2){
     return tVetor1.xcomp * tVetor2.xcomp + tVetor1.ycomp * tVetor2.ycomp;   
} 
...
Vetor Soma2Vetores(Vetor tVetor1, Vetor tVetor2){
     Vetor VetorResultado;
     VetorResultado = new Vetor(0,0);
     VetorResultado.xcomp = tVetor1.xcomp + tVetor2.xcomp;
     VetorResultado.ycomp = tVetor1.ycomp + tVetor2.ycomp;
